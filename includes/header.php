...
<head>
    ...
    <title><?php echo $pageTitle ?? $page_title ?? 'Paso Chilero'; ?></title>

    <!-- Ícono de la ventana del navegador (Favicon) -->
    <link rel="icon" type="image/svg+xml" href="<?php echo rtrim($base_url, '/'); ?>/assets/img/logo.svg">

    <!-- Romper caché automáticamente -->
